    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if(window.location.href.indexOf("verify") > -1) {
                $("#verify").html("Please complete your email verification!");
            }
            if(window.location.href.indexOf("nonexistent_account") > -1 || window.location.href.indexOf("wrong_password") > -1) {
                $("#verify").html("Invalid login info! Please make sure you entered the correct email and password.");
            }
        });
    </script>
</head>
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <div class="panel panel-custom">
                <div class="panel-heading" id="login-header"><h3>Login<h4 id="verify"><h4></h3></div>
