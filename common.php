...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            var loggedInContent =
                "<li class='dropdown'>" +
                "<a class='dropdown-toggle' data-toggle='dropdown' href='#'>" + "<img src='" + common_avatar + "'" + " style='width:20px;height:20px;' id='common_avatar'>  " + userFirstName + " <span class='caret'></span></a><ul class='dropdown-menu'>" +
